/*Este es el código que le da una personalización al Video player nativo de Chrome u otros navegadores, le da acceso a otras funciones
como modificar la velocidad de reproducción, cambiar el lenguaje en el que se reproduce, la calidad en la que se visualiza el contenido,
mostrar u ocultar los subtítulos del video y por último el opción de PIP que permite suporponer el video en otras ventanas u aplicaciones
para seguir viendo el video sin necesidad de tener el navegador en primer plano.*/
            ...
            },
            {
              ...
              value: function () {
                var e = this.player,
                  t = e.elements;
                if (
                  (y.call(e, e.media, "timeupdate seeking seeked", function (
                    t
                  ) {
